...
//Thay dia chi web
var endAddress = "10.760563,106.620329";
//Thay toa do
var lat = 10.760563, long = 106.620329;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h4 class="title-2">CÔNG TY TNHH SX-TM HIẾU HƯƠNG</h4>' +
            ...
            '<p><span class="fa fa-envelope"></span><a href="mailto: contact@hieuhuongplastics.com">contact@hieuhuongplastics.com</a></p>'
        '</div>';
