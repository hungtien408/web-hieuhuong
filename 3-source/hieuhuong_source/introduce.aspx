        ...
        <div class="row">
            <div role="tabpanel">
                ...
                <asp:ListView ID="lstAbout" runat="server" DataSourceID="odsAbout" EnableModelValidation="True">
                    <ItemTemplate>
                        <li role="presentation"><a href='<%# "#" + progressTitle(Eval("ArticleTitle")) + "-" + Eval("ArticleID") %>'
                ...
                <div class="tab-content col-md-8">
                    <asp:ListView ID="lstAboutDetails" runat="server" DataSourceID="odsAbout" EnableModelValidation="True">
                        <ItemTemplate>
                            <div role="tabpanel" class="tab-pane" id='<%# progressTitle(Eval("ArticleTitle")) + "-" + Eval("ArticleID") %>'>
